            ...
            {!callDetails ? (
                ...
                >
                    <div className="flex flex-col gap-2.5">
                        <label className="text-base text-normal text-sky-2 leading-[22px]">Add a description</label>
                        <Textarea
                            className="border-none bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
                    ...
                    <div className="flex w-full flex-col gap-2.5">
                        <label className="text-base text-normal text-sky-2 leading-[22px]">Select Date and Time</label>
                        <ReactDatePicker
